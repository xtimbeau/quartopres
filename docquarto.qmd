...
## avec des graphiques interactifs
...
-   reveal js (pour une présentation)

-   un blog (un site web complet)
...
-   Il peut être édité par différents programmes dont RStudio
    ...
    -   qui bénéficie d'un mode `visual`, où l'on prévisualise l'aspect, les équations et où on peut coller des images provenant de n'importe où. (des copies d'écran comme ici).
...
Quarto doit pouvoir s'utiliser dans une grande variété d'éditeurs/environnement

Développer des templates, de modèles pour simplifier la production
